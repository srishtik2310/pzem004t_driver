 ...
 * Addresses correspond to sensor measurent.
 */
...
#define PZEM004T_POWER_SCALE 1           /* Power in watts */
#define PZEM004T_ENERGY_SCALE 1          /* Energy in watt-hours */
#define PZEM004T_FREQUENCY_SCALE 10      /* Frequency in 0.1Hz */
#define PZEM004T_POWER_FACTOR_SCALE 1000 /* Power factor scaled by 1000 */
...
struct pzem004t_data
{
    ...
    bool modbus_initialized;        /* Modbus initialization status */
